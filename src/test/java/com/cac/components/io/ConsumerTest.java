...
class ConsumerTest {
    ...
    void consumeOneOf() {
        instance = new Consumer("abc");
        Assertions.assertEquals(Character.valueOf('a'), instance.consumeOneOf(Lists.newArrayList('a', 'b')));
        Assertions.assertEquals("bc", instance.getRep());
    }
    ...
    void cannotConsumeOneOf() {
        instance = new Consumer("abc");
        assertThrows(AssertionError.class, () -> instance.consumeOneOf(Lists.newArrayList('b', 'c')));
    }
    ...
    void consumeToOneOf() {
        instance = new Consumer("abcdef");
        Assertions.assertEquals("abc", instance.consumeToOneOf(Lists.newArrayList('d', 'e', 'f')));
        Assertions.assertEquals("def", instance.getRep());
    }
    ...
    void cannotConsumeToOneOf() {
        instance = new Consumer("abcdef");
        assertThrows(AssertionError.class, () -> instance.consumeToOneOf(Lists.newArrayList('g', 'h', 'i')));
    }
    ...
    void consumeThroughOneOf() {
        instance = new Consumer("abcdefghi");
        Assertions.assertEquals("abcdef", instance.consumeThroughOneOf(Lists.newArrayList('f')));
        Assertions.assertEquals("ghi", instance.getRep());
    }
