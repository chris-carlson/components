...
public class Consumer {
    ...
    public Character consumeOneOf(List<Character> characters) {
        Character consumedChar = peek();
    ...
    public String consumeTo(Character character) {
        return consumeToOneOf(Lists.newArrayList(character));
    }

    public String consumeToOneOf(List<Character> characters) {
    ...
    public String consumeThrough(Character character) {
        return consumeThroughOneOf(Lists.newArrayList(character));
    }

    public String consumeThroughOneOf(List<Character> characters) {
    ...
    private boolean containsOneOf(List<Character> characters) {
