...
public class KeyEvent extends InputEvent {
    private static final Map<Integer, Key> KEY_MAPPER = MapBuilder.buildMap(
            Map.entry(java.awt.event.KeyEvent.VK_ESCAPE, Key.ESC), Map.entry(java.awt.event.KeyEvent.VK_F1, Key.F1),
            Map.entry(java.awt.event.KeyEvent.VK_F2, Key.F2), Map.entry(java.awt.event.KeyEvent.VK_F3, Key.F3),
            Map.entry(java.awt.event.KeyEvent.VK_F4, Key.F4), Map.entry(java.awt.event.KeyEvent.VK_F5, Key.F5),
            Map.entry(java.awt.event.KeyEvent.VK_F6, Key.F6), Map.entry(java.awt.event.KeyEvent.VK_F7, Key.F7),
            Map.entry(java.awt.event.KeyEvent.VK_F8, Key.F8), Map.entry(java.awt.event.KeyEvent.VK_F9, Key.F9),
            Map.entry(java.awt.event.KeyEvent.VK_F10, Key.F10), Map.entry(java.awt.event.KeyEvent.VK_F11, Key.F11),
            Map.entry(java.awt.event.KeyEvent.VK_F12, Key.F12),
            Map.entry(java.awt.event.KeyEvent.VK_BACK_QUOTE, Key.BACK_QUOTE),
            Map.entry(java.awt.event.KeyEvent.VK_1, Key.NUM_1), Map.entry(java.awt.event.KeyEvent.VK_2, Key.NUM_2),
            Map.entry(java.awt.event.KeyEvent.VK_3, Key.NUM_3), Map.entry(java.awt.event.KeyEvent.VK_4, Key.NUM_4),
            Map.entry(java.awt.event.KeyEvent.VK_5, Key.NUM_5), Map.entry(java.awt.event.KeyEvent.VK_6, Key.NUM_6),
            Map.entry(java.awt.event.KeyEvent.VK_7, Key.NUM_7), Map.entry(java.awt.event.KeyEvent.VK_8, Key.NUM_8),
            Map.entry(java.awt.event.KeyEvent.VK_9, Key.NUM_9), Map.entry(java.awt.event.KeyEvent.VK_0, Key.NUM_0),
            ...
            Map.entry(java.awt.event.KeyEvent.VK_SHIFT, Key.SHIFT), Map.entry(java.awt.event.KeyEvent.VK_Z, Key.Z),
            Map.entry(java.awt.event.KeyEvent.VK_X, Key.X), Map.entry(java.awt.event.KeyEvent.VK_C, Key.C),
            Map.entry(java.awt.event.KeyEvent.VK_V, Key.V), Map.entry(java.awt.event.KeyEvent.VK_B, Key.B),
            Map.entry(java.awt.event.KeyEvent.VK_N, Key.N), Map.entry(java.awt.event.KeyEvent.VK_M, Key.M),
            ...
            Map.entry(java.awt.event.KeyEvent.VK_CONTROL, Key.CTRL), Map.entry(java.awt.event.KeyEvent.VK_ALT, Key.ALT),
            Map.entry(java.awt.event.KeyEvent.VK_SPACE, Key.SPACE), Map.entry(java.awt.event.KeyEvent.VK_UP, Key.UP),
            Map.entry(java.awt.event.KeyEvent.VK_DOWN, Key.DOWN), Map.entry(java.awt.event.KeyEvent.VK_LEFT, Key.LEFT),
            ...
            Map.entry(java.awt.event.KeyEvent.VK_HOME, Key.HOME), Map.entry(java.awt.event.KeyEvent.VK_END, Key.END),
